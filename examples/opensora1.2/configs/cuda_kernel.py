...
model = dict(
    type="STDiT3-XL/2",
    from_pretrained="/root/autodl-tmp/models/hpcai-tech/OpenSora-STDiT-v3",
    qk_norm=True,
...
vae = dict(
    ...
    from_pretrained="/root/autodl-tmp/models/hpcai-tech/OpenSora-VAE-v1.2",
    micro_frame_size=17,
    micro_batch_size=4,
)
text_encoder = dict(
    type="t5",
    from_pretrained="/root/autodl-tmp/models/DeepFloyd/t5-v1_1-xxl",
