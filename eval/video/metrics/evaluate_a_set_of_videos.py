...
if __name__ == "__main__":
    ...
    if args.dir_results=='':
        out_path = f'../../results/VQA_record.csv'
    else:
        out_path = args.dir_results+'/VQA_record.csv'
    ...
    # print first
    print(f'Avg. scores: Aesthetic: {aesthetic_sum/len(dataloader)}, Technical: {technical_sum/len(dataloader)}, Overall: {overall_sum/len(dataloader)}\n')
