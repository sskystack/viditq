...
if __name__ == '__main__':
    ...
    clip_model = CLIPModel.from_pretrained("/share/public/video_quant/wanrui/metrics/I2VBench/checkpoints/clip-vit-base-patch32").to(device)
    clip_tokenizer = AutoTokenizer.from_pretrained("/share/public/video_quant/wanrui/metrics/I2VBench/checkpoints/clip-vit-base-patch32")
