...
class PickScore(nn.Module):
    def __init__(self, device='cpu'):
        ...
        processor_name_or_path = "/home/liuenshu/.cache/metric_models/models--laion--CLIP-ViT-H-14-laion2B-s32B-b79K/snapshots/94a64189c3535c1cb44acfcccd7b0908c1c8eb23"
        model_pretrained_name_or_path = "/home/liuenshu/.cache/metric_models/models--yuvalkirstain--PickScore_v1/snapshots/a4e4367c6dfa7288a00c550414478f865b875800"
    ...
    def inference_rank(self, prompt, generations_list):
        ...
        with torch.no_grad():
            ...
            for i, img_name in enumerate(file_list):
                ...
                txt_set.append(text_embs[i].unsqueeze(0))
