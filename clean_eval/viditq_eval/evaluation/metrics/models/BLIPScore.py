...
from metrics.models.BLIP.blip import load_checkpoint
from metrics.models.BLIP.blip_pretrain import BLIP_Pretrain
...
class BLIPScore(nn.Module):
    ...
    def score(self, prompt, image_path):
        ...
        return _, rewards.detach().cpu().numpy().item()
    ...
    def inference_rank(self, prompt, generations_list):
        ...
        with torch.no_grad():
            for i, img_name in enumerate(file_list):
                print(f"Image {img_name}. Calculating...")
                # image encode
                ...
                txt_set.append(txt_feature[i].unsqueeze(0))
