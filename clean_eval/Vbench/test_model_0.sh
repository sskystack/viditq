...
cd /home/zhuhongyu/diffuser-dev/clean_eval/Vbench #evaluate.py文件位置
export VBENCH_CACHE_DIR="/share/public/video_quant/vm_ckpt/" #本地下载地址
...
VIDEO_PATH="/share/public/video_quant/wanrui/VBench/our_video/qdiff_88" #视频地址
OUTPUT="./evaluation_results/qdiff_88_${current_time}" #输出结果地址

#如果出现torch.hub.load报错可以尝试使用本地下载，讲--load_ckpt_from_local设置为True
