...
cd /home/zhuhongyu/clean_eval/Vbench #evaluate.py文件位置
...
VIDEO_PATH="/share/public/video_quant/wanrui/VBench/our_video/qdiff_88"
OUTPUT="./evaluation_results/qdiff_88_${current_time}"
